...
@Tag(name = "Assets Resources Management", description = "Provide the ability of assets management and information")
@RestController
...
public class AssetController {
	...
	@Operation(summary = "Create new asset feature", description = "Create new asset with name, installed date , specification and asset state ")
	...
	@Operation(summary = "Retrieved assets by asset code, name or location", description = "Get assets with  given name or code and location of asset")
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "OK - Successfully retrieved"),
			@ApiResponse(responseCode = "400", description = "Bad Request - The request is invalid", content = {
					@Content(examples = { @ExampleObject() }) }),
			@ApiResponse(responseCode = "401", description = "UNAUTHORIZED - The request is unauthorized"),
	...
	@Operation(summary = "Delete assets", description = "If asset is not belonged to any assignments, Admin can delete it")
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "OK - Successfully retrieved"),
			...
			@ApiResponse(responseCode = "409", description = "CONFLICT - The asset cannot deleted cause it's already belonged to an existing assignment"),
			@ApiResponse(responseCode = "500", description = "Internal Error - There were some error while processing in server", content = {
					@Content(examples = { @ExampleObject() }) }) })
